...
class TestE2E:
    def test_end_2_end_purchase_with_new_account(self):
        ...
        account_page.fill_shipping_address(config_account.STREET_ADDRESS, config_account.CITY,
                                           config_account.COUNTRY
                                           , config_account.PHONE_NUMBER, config_account.ZIP_CODE)
